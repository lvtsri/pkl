      ...
      <div class="container-fluid">
        <div class="card">
          ...
          <div class="card-body">
              ...
              // Ambil data dosen dari database berdasarkan nik
              $query_dosen = mysqli_query($koneksi, "SELECT * FROM tb_dosen WHERE nik = '$pengguna'");
              $data = mysqli_fetch_assoc($query_dosen);

              // Jika data tidak ditemukan, kembalikan ke halaman data dosen
              if (!$data) {
                  echo '<script>alert("Data tidak ditemukan!"); window.location.href="../admin_data_dosen";</script>';
                  exit;
              }
              ...
              <form action="ubah.php" method="post">
                  <div class="form-group">
                      ...
                      <input type="text" name="nik_disable" class="form-control" id="nik" value="<?= $nik; ?>" disabled>
                      <input type="text" name="nik" class="form-control" id="nik" value="<?= $nik; ?>" hidden>
                  </div>
                  <div class="form-group">
