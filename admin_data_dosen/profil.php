...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
        ...
        $query_ambil_data = mysqli_query($koneksi, "SELECT * FROM tb_dosen WHERE nik = '$dosen'");
        $data = mysqli_fetch_assoc($query_ambil_data);
        if(!$data){
            echo '<script>
                alert("Data dosen tidak ditemukan!");
                window.location.href="../admin_data_dose ";
                exit;
            </script>';
        }
                    ...
                    <div class="card-body">
                        <div class="mb-3 text-center">
                            ...
                            <?php
                                if ($kelamin == 'P') {
                            ?>
                                <img src="<?= (!empty($img))?$img : '../asset_web/img/dosen-woman.jpg'?>" style="width: 190px; height: 190px; object-fit: cover;">
                            <?php
                                } else {
                            ?>
                                <img src="<?= (!empty($img))?$img : '../asset_web/img/dosen-man.jpg'?>" style="width: 190px; height: 190px; object-fit: cover;">
                            <?php
                                }
                            ?>
                        </div>
                        <button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#modal-ubah-foto" data-nik="<?= $nik; ?>">
